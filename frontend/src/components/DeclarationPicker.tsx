      ...
      >
        ...
        <div className="p-6 border-b border-[#2A2A2A]">
          ...
          <input
            ...
            className="w-full px-4 py-2.5 bg-[#141414] border border-[#2A2A2A] text-[#F5F3F0] placeholder-[#8A8A8A] focus:border-[#8A8A8A] outline-none text-sm"
            autoFocus
          />
        </div>
            ...
            <div className="space-y-2">
              {filteredDeclarations.map((declaration) => (
                <button
                  ...
                  className="w-full text-left p-4 bg-[#141414] border border-[#2A2A2A] hover:border-[#8A8A8A] transition-colors duration-100"
                >
